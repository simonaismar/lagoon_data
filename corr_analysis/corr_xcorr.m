...
% load data
cd /home/simo/Dropbox/research/CNR/IAS/dati_mareografo/salinity
load('saltemp_proc.mat', 'salinity1_sm')
load('saltemp_proc.mat', 'temperature1_sm')
load('saltemp_proc.mat', 'time1')
cd /home/simo/Dropbox/research/CNR/IAS/dati_mareografo/correlations/xcorr_plots
% correlation
...
% time lag
[C_st,lag]=xcorr(salinity1_sm(1:266),temperature1_sm(1:266),'coeff');
[M_st,I]=max(abs(C_st));
...
% load data
cd /home/simo/Dropbox/research/CNR/IAS/dati_mareografo/AWAC
...
salc=salinity1_sm(1:99);
tempc=temperature1_sm(1:99);
...
sshc=timed_ssh_sm(861:end); % 861 is the index of the starting time
...
% load data 
cd /home/simo/Dropbox/research/CNR/IAS/dati_mareografo/tide_gauge
...
load('tidelagoon_analysis_proc.mat', 'residual_ssh_sm')
load('tidelagoon_analysis_proc.mat', 'timen')
cd /home/simo/Dropbox/research/CNR/IAS/dati_mareografo/correlations/xcorr_plots
% correlation
% common time 
timed_ssh_sm=residual_ssh_sm(3:4:end);
...
salc2=salinity1_sm(5:266);
ssh_tidec=sshtu(1:262);
...
cd /home/simo/Dropbox/research/CNR/IAS/dati_mareografo/copernicus
load('read_data_l4.mat', 'sla_tide')
load('read_data_l4.mat', 'sla_awac')
load('read_data_l4.mat', 'final_time')
cd /home/simo/Dropbox/research/CNR/IAS/dati_mareografo/correlations/xcorr_plots

sla_tidec=sla_tide(89:138);
%tmp=[timen(1:48:end);timen(end)];
stc=[residual_ssh_sm(1:48:end);residual_ssh_sm(end)];
...
% correlation
sla_awacc=sla_awac(17:97);
sac=[ssh_awac(1:48:end);ssh_awac(end)];
